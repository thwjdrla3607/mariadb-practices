...
-- 예제4: titles 테이블에서 직급은 어떤 것들이 있는지 직급이름을 한 번씩만 출력하세요.
...
select first_name, gender, hire_date
 ...
 -- 예제3: in 연산자: dept_emp 테이블에서 부서번호가 d005이거나 d009에 속한 사원의 사번, 부서 번호를 출력
...
-- 예제1: employees 테이블에서 직원 이름, 성별, 입사일을 빠른 순으로 출력
