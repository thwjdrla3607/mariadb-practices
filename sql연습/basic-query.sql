...
-- insert: DML(C)
insert into pet values('성탄이', '김소정', 'dog', 'm', '2019-12-25', null);
...
-- load data
load data local infile 'C:/poscodx/eclipse-workspace/mariadb-practies/pet.txt' into table pet;
