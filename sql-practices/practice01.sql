...
-- 문제6.
-- 현재 부서 매니저는 몇 명이나 있나요?(역임 매너저는 제외) //다시풀기
describe dept_manager;
select count(*) from dept_manager where to_date = '9999-01-01';

-- 문제7.(x)
-- 전체 부서를 출력하려고 합니다. 순서는 부서이름이 긴 순서대로 출력해 보세요.
select first-name, length(first_name) from employees;
...
SELECT first_name FROM employees WHERE emp_no = 13250;
